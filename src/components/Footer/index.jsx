      ...
      <Section tag='footer' className="cs-footer text-center">
        <Section className="container">
          ...
          <Section className="cs-footer_logo">
            <img src="/images/logo_footer.svg" alt="logo " width="12%" className="cs-hide_dark" />
            <img src="/images/logo_footer_white.svg" alt="logo" width="12%" className="cs-hide_white" />
          </Section>
        ...
        <Section className="container">
          <Section className="cs-copyright text-center">Copyright © {new Date().getFullYear()}. All Rights Reserved by ENFT. <span className="cs-primary_font cs-primary_color">Designed By Abdul Wahab</span></Section>
        </Section>
        <Section className="cs-height_25 cs-height_lg_25" />
      </Section>
    </Section>
